    ...
    ***************************************************************************** */
    ...
    var Loader = (function (_super) {
        ...
        function Loader() {
            ...
            _this.onSuccess = function (google) {
                var onSucces = _this.props.onSucces;
                _this.setState({
                    loadingStatus: "ready",
                    google: google
                });
        ...
        Loader.prototype.render = function () {
            var _a = this.props, chartLanguage = _a.chartLanguage, chartPackages = _a.chartPackages, chartVersion = _a.chartVersion, mapsApiKey = _a.mapsApiKey;
            return (React.createElement(ContextProvider, { value: { chartLanguage: chartLanguage, chartPackages: chartPackages, chartVersion: chartVersion, mapsApiKey: mapsApiKey } },
                React.createElement(GoogleChartLoader, __assign({}, { chartLanguage: chartLanguage, chartPackages: chartPackages, chartVersion: chartVersion, mapsApiKey: mapsApiKey }, { onLoad: this.onLoad, onError: this.onError }))));
        };
        ...
        Loader.prototype.isFullyLoaded = function (google) {
            var _a = this.props, controls = _a.controls, toolbarItems = _a.toolbarItems, getChartEditor = _a.getChartEditor;
            return (google &&
                google.visualization &&
                google.visualization.ChartWrapper &&
        ...
        Loader.defaultProps = chartDefaultProps;
        return Loader;
    }(React.Component));
